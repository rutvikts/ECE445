...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOA, TIM2_CH1_ME1_ChA_Pin|TIM2_CH2_ME1_ChB_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB5     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOB, TIM3_CH1_ME2_ChA_Pin|TIM3_CH2_ME2_ChB_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB7     ------> TIM4_CH2
    */
    HAL_GPIO_DeInit(GPIOB, TIM4_CH1_ME3_ChA_Pin|TIM4_CH2_ME3_ChB_Pin);
